...
\tikzstyle{every node}=[font=\scriptsize\sffamily,align=center]
\def\boxheight{0.4cm};
\def\isep{4pt};

% Component types
\tikzstyle{Optimization} = [rounded rectangle,draw,fill=blue!20,inner sep=\isep,minimum height=\boxheight,text badly centered]
\tikzstyle{OptimizationB} = [rounded rectangle,draw,fill=blue!20,inner sep=\isep,minimum height=\boxheight,text badly centered, line width=1.5pt]
\tikzstyle{LP_Optimization} = [rectangle,draw,fill=tableau4!50,inner sep=\isep,minimum height=\boxheight,text badly centered]
\tikzstyle{Analysis} = [rectangle,draw,fill=green!20,inner sep=\isep,minimum height=\boxheight,text badly centered]
\tikzstyle{ImplicitAnalysis} = [rectangle,draw,fill=tableau3!50,inner sep=\isep,minimum height=\boxheight,text badly centered]
\tikzstyle{Function} = [rectangle,draw,fill=tableau2!50,inner sep=\isep,minimum height=\boxheight,text badly centered]
\tikzstyle{MDA} = [rounded rectangle,draw,fill=tableau5!50,inner sep=\isep,minimum height=\boxheight,text badly centered]
\tikzstyle{Metamodel} = [chamfered rectangle,draw,fill=tableau8!50,inner sep=\isep,minimum height=\boxheight,text badly centered]
\tikzstyle{DOE} = [rounded rectangle,draw,fill=tableau8!50,inner sep=\isep,minimum height=\boxheight,text badly centered]
%\tikzstyle{OptFunction} = [rectangle,draw,fill=red!20,inner sep=\isep,minimum height=\boxheight,text badly centered]
...
\tikzstyle{DataInterB} = [trapezium,trapezium left angle=75,trapezium right angle=105,draw,fill=black!10, line width=1.5pt]
...
% Edges
\tikzstyle{DataLine} = [color=black!25,line width=4pt,line cap=rect]
